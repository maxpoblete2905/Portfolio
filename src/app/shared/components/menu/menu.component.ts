...
export class MenuComponent {
  ...
  public sections = [
    ...
    { route: 'skills', name: 'Skills', icon: 'https://firebasestorage.googleapis.com/v0/b/portfolio-549f8.appspot.com/o/portfolio%2Ftecnologias%2Fskills.png?alt=media&token=d2807831-2bef-4af7-84c1-e665ff43fb0b' },  // Habilidades con el color adecuado
    ...
    { route: 'contact', name: 'Contacto', icon: 'https://cdn-icons-png.flaticon.com/128/732/732200.png' }
  ];
}
